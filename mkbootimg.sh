...
# remove old
rm output/mkbootimg_tools/pb1/dt.img
rm output/mkbootimg_tools/pb1/kernel

# copy new
cp arch/arm/boot/dt.img output/mkbootimg_tools/pb1/dt.img
cp arch/arm/boot/zImage output/mkbootimg_tools/pb1/zImage
mv output/mkbootimg_tools/pb1/zImage output/mkbootimg_tools/pb1/kernel
